...
export type CheckoutLineItemCustomOrderAddDiscountCodeMutationVariables = Exact<{
  checkoutId: Scalars['ID'];
  discountCode: Scalars['String'];
}>;

export type CheckoutLineItemCustomOrderAddDiscountCodeMutation = {
  __typename?: 'Mutation';
} & {
...
export type CheckoutLineItemCustomOrderRemoveDiscountCodeMutationVariables = Exact<{
  checkoutId: Scalars['ID'];
}>;

export type CheckoutLineItemCustomOrderRemoveDiscountCodeMutation = {
  __typename?: 'Mutation';
} & {
